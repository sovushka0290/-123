  ...
  return (
    <div className="space-y-12 py-4" id="home-view">
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-4" id="stats-grid">
        {[
          { title: 'Потери граждан в РК', value: '45 млрд ₸', desc: 'Сумма похищенных средств злоумышленниками методами социальной инженерии в Казахстане за прошлый год.', color: 'text-rose-400' },
          { title: 'Основной канал угроз', value: '89% звонков', desc: 'Переместились в мессенджеры Telegram и WhatsApp под масками сотрудников eGov или Kaspi/Halyk.', color: 'text-yellow-400' },
          { title: 'Новые поддельные домены', value: '> 3 000 в сутки', desc: 'Фишинговых страниц и фейковых розыгрышей создается ежедневно в зоне .KZ и мобильных сетях.', color: 'text-amber-500' },
          { title: 'Эффективность СМС-кодов', value: '94% взломов', desc: 'Происходят из-за добровольной передачи СМС-кода третьим лицам под психологическим манипулированием.', color: 'text-emerald-400' }
        ].map((card, idx) => (
          <motion.div 
            key={idx}
